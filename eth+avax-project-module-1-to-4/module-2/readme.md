...
1. **Make 3 terminals inside VS** click the **`+`** on terminal tab, or press **`Ctrl + Shift + ``** and at each separate terminal copy paste the following commands at **steps 3 to 5**
